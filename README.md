# Build It Bigger
Build It Bigger is an Android app which tells jokes. This app is created with 
multiple flavors that uses multiple libraries and Google Cloud Endpoints. 
This is a Project 4 (Gradle for Android and Java Final Project) of [Udacity's 
Android Developer Nanodegree](https://www.udacity.com/course/android-developer-nanodegree-by-google--nd801).

# Used Programs or Libraries in this project
* [AdMob](https://developers.google.com/admob/android/quick-start)
* [Google Cloud Endpoints](https://cloud.google.com/sdk/docs/)
